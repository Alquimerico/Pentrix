...
class BuildExe:
    def __init__(self):
        ...
        self.license = "GNU GLP"

        #Auhor of program
        self.author_name = "Ao Kin Ecab Gutierrez"
        self.author_email = "alquimerico@cryptolab.net"
        self.copyright = "Copyright (c) 2017 Me."

        #Description
        self.project_description = "Pentrix, un tetris diferente"

        #Icon file (None will use pygame default icon)
        self.icon_file = None

        #Extra files/dirs copied to game
        self.extra_datas = ["circuit.ttf","djwill96_-_Day_'n'_Nite_v2.mid","pepperoni_pizza.ttf","Video_Game_Themes_-_Crash_Bandicoot_Warped.mid"]
